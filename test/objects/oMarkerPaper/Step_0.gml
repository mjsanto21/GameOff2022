...
if (instance_exists(oPlayer)) && (point_in_circle(oPlayer.x,oPlayer.y,x,y,400))
{
...
if (image_alpha > 0) && (instance_exists(oPlayer)) &&  (!point_in_circle(oPlayer.x,oPlayer.y,x,y,400))
{
